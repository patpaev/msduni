    ...
    attach: function(context, settings) {
      ...
      for (var key in beautytips) {
        ...
        if (beautytips[key]['cssSelect']) {
          ...
          if (beautytips[key]['keepOpenWhenHovering']) {
        	  btOptions['trigger'] = 'hoverIntent';
        	  btOptions['hoverIntentOpts'] = {
        			  interval: 0,
        			  timeout: 500,
        	  }
        	  // from: http://stackoverflow.com/questions/4034671/how-to-make-jquery-beauty-tip-stay-open-as-long-as-the-cursor-is-over-the-toolti
        	  btOptions['postShow'] = function(box) {
	    		  $(box).hoverIntent({
	    			  over: function() {
