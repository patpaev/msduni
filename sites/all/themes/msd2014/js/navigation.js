...
Navigation = (function() {
  ...
  function buildNestedNav() {
    var nav = getElementByClassName(document.getElementsByTagName('div'), 'menu-block-1') ||
    	getElementByClassName(document.getElementsByTagName('div'), 'nav') || 
