<div id="page" class="infrastructure wrapper <?php print !empty($show_grid) ? 'show-grid' : '' ?>">
    <!-- Header Area -->
    <div class="header">
        <div class="hgroup">
...
<?php
    ...
    $images = field_get_items('node', $node, 'thumbnail');
    if(!empty($images)) {
    
    	$image = field_view_value('node', $node, 'thumbnail', $images[0], array(
        	'type' => 'image',
